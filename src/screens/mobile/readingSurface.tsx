        ...
        (pressed || transientPressed) && !disabled
          ? variant === "primary"
            ...
            : [
                ...
                Platform.OS === "web" ? WEB_DEFAULT_BUTTON_PRESSED : null,
              ]
          : null,
...
export function SurfaceIconButton({
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        styles.iconButton,
        Platform.OS === "web" ? WEB_ICON_BUTTON_STYLE : null,
        (pressed || transientPressed) && !disabled
          ? [styles.secondaryButtonPressed, Platform.OS === "web" ? WEB_ICON_BUTTON_PRESSED : null]
          : null,
        disabled ? styles.buttonDisabled : null,
        style,
      ]}
